...
insert into Etudiant values (20070001,0,'PUM20001',885,01,03,01,'81','11','puechlong','joris','joris@redoublant.com');
insert into Etudiant values (20070002,0,'PUM2002',990,01,03,01,'81','11','jambet','pierre','pierre@nicolas.con');
insert into Etudiant values (20070003,0,'PUM2003',255,01,03,01,'81','11','dreyer','quentin', 'quentin@dreyer.fr');
insert into Etudiant values (20070004,0,'PUM2004',010,04,03,02,'81','11','michel','benjamin','benji@china.cn');
insert into Etudiant values (20070005,0,'PUM2005',235,01,69,04,'81','11','coudsi','julien','besseges@uneseulerace.bes');

insert into Etudiant values (20070006,0,'PUM2006',700,01,03,01,'61','10','costanza','guillaume','gc@popo.fr');
insert into Etudiant values (20070007,0,'PUM2007',700,01,03,01,'61','10','rance','justine','rancitude@laposte.net');
insert into Etudiant values (20070008,0,'PUM2008',700,01,03,01,'61','10','paze','yannick','dieguito@pasderace.com');

insert into Etudiant values (20070009,0,'PUM2009',500,01,03,01,'62','20','meyer','lisa','jsuitrobonne@sex.xx');
insert into Etudiant values (20070010,0,'PUM2010',500,01,03,01,'62','20','asse','bomb','6@9.xnxx');
